...
from pkboost_sklearn import PKBoostClassifier, PKBoostRegressor
...
def test_grid_search():
    ...
    print(
        f"[OK] Testing {len(param_grid['n_estimators']) * len(param_grid['learning_rate']) * len(param_grid['max_depth'])} combinations"
    )
